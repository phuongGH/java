...
public class TableModel {
    ...
    public boolean insert(TableT tableObj){
        try {
            sf.getCurrentSession().beginTransaction();
            sf.getCurrentSession().save(tableObj);
     ...
     public boolean delete(TableT tableObj){
        try {
            sf.getCurrentSession().beginTransaction();
            sf.getCurrentSession().delete(tableObj);
            sf.getCurrentSession().getTransaction().commit();
            sf.getCurrentSession().close();
            return true;
        } catch (HibernateException e) {
     ...
     public boolean update(TableT tableObj){
        try {
            sf.getCurrentSession().beginTransaction();
            sf.getCurrentSession().update(tableObj);
            sf.getCurrentSession().getTransaction().commit();
            sf.getCurrentSession().close();
            return true;
        } catch (HibernateException e) {
